...
public unsafe class NativeMethodInfoStructHandler_29_1 : INativeMethodInfoStructHandler
{
    public int Size()
    {
        return sizeof(Il2CppMethodInfo_29_1);
    }

    public INativeMethodInfoStruct CreateNewStruct()
    {
        var ptr = Marshal.AllocHGlobal(Size());
        var _ = (Il2CppMethodInfo_29_1*)ptr;
        *_ = default;
    ...
    internal class NativeStructWrapper : INativeMethodInfoStruct
    {
        private static readonly int _bitfield0offset =
            Marshal.OffsetOf<Il2CppMethodInfo_29_1>(nameof(Il2CppMethodInfo_29_1._bitfield0)).ToInt32();
