...
public unsafe class NativeMethodInfoStructHandler_16_0 : INativeMethodInfoStructHandler
{
    public int Size()
    {
        return sizeof(Il2CppMethodInfo_16_0);
    }

    public INativeMethodInfoStruct CreateNewStruct()
    {
        var ptr = Marshal.AllocHGlobal(Size());
        var _ = (Il2CppMethodInfo_16_0*)ptr;
        *_ = default;
    ...
    internal class NativeStructWrapper : INativeMethodInfoStruct
    {
        private static readonly int _bitfield0offset =
            Marshal.OffsetOf<Il2CppMethodInfo_16_0>(nameof(Il2CppMethodInfo_16_0._bitfield0)).ToInt32();
