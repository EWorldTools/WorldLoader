...
public unsafe class NativeMethodInfoStructHandler_24_1 : INativeMethodInfoStructHandler
{
    public int Size()
    {
        return sizeof(Il2CppMethodInfo_24_1);
    }

    public INativeMethodInfoStruct CreateNewStruct()
    {
        var ptr = Marshal.AllocHGlobal(Size());
        var _ = (Il2CppMethodInfo_24_1*)ptr;
        *_ = default;
    ...
    internal class NativeStructWrapper : INativeMethodInfoStruct
    {
        private static readonly int _bitfield0offset =
            Marshal.OffsetOf<Il2CppMethodInfo_24_1>(nameof(Il2CppMethodInfo_24_1._bitfield0)).ToInt32();
        ...
        public bool IsMarshalledFromNative
        {
            ...
            set => this.SetBit(_bitfield0offset, (int)Il2CppMethodInfo_24_1.Bitfield0.BIT_is_marshaled_from_native,
                value);
        }
    }
}
