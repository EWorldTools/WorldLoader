...
public unsafe class NativeClassStructHandler_21_0 : INativeClassStructHandler
{
    public int Size()
    {
        return sizeof(Il2CppClass_21_0);
    }
    ...
    public INativeClassStruct CreateNewStruct(int vTableSlots)
    {
        ...
        var _ = (Il2CppClass_21_0*)ptr;
        *_ = default;
        Marshal.FreeHGlobal(ptr);
        throw new NotSupportedException(
            "The native struct 'Il2CppClass_21_0' has a vtable field which is not currently supported!");
    ...
    internal class NativeStructWrapper : INativeClassStruct
    {
        private static readonly int _bitfield0offset =
            Marshal.OffsetOf<Il2CppClass_21_0>(nameof(Il2CppClass_21_0._bitfield0)).ToInt32();
