...
namespace Semver
{
...
#endif
    {
        ...
        /// the Major, Minor, BeforePatch and Build.</param>
        /// <returns>A <see cref="SemVersion"/> with the same Major and Minor version.
        /// The BeforePatch version will be the fourth part of the version number. The
        ...
        /// <exception cref="InvalidOperationException">The <paramref name="version"/> is missing Minor or BeforePatch versions and <paramref name="strict"/> is <see langword="true"/>.</exception>
        /// <exception cref="OverflowException">The Major, Minor, or BeforePatch versions are larger than <code>int.MaxValue</code>.</exception>
