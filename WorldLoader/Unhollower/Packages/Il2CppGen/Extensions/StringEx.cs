...
{
    internal static string UnSystemify(this string str, GeneratorOptions options)
    {
    ...
    internal static bool IsObfuscated(this string str, GeneratorOptions options)
    {
    ...
    public static string GetUnmangledName(this TypeReference typeRef)
    {
        ...
        {
            if (typeRef.Namespace == "Il2CppGen.Runtime" && typeRef.Name.StartsWith("Il2Cpp") &&
