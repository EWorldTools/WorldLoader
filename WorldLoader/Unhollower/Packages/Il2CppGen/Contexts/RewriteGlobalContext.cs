...
public class RewriteGlobalContext : IDisposable
{
    ...
    private readonly Dictionary<string, UnhollowedAssemblyContext> myAssemblies = new();
    private readonly Dictionary<AssemblyDefinition, UnhollowedAssemblyContext> myAssembliesByOld = new();
        ...
        IMetadataAccess unityAssemblies)
    {
        ...
        foreach (var sourceAssembly in gameAssemblies.Assemblies)
        {
            ...
            var assemblyRewriteContext = new UnhollowedAssemblyContext(this, sourceAssembly, newAssembly);
    ...
    public IEnumerable<UnhollowedAssemblyContext> Assemblies => myAssemblies.Values;
    ...
    internal void AddAssemblyContext(string assemblyName, UnhollowedAssemblyContext context)
    {
    ...
    public UnhollowedAssemblyContext GetNewAssemblyForOriginal(AssemblyDefinition oldAssembly)
    {
        try
        {
    ...
    public UnhollowedAssemblyContext? GetAssemblyByName(string name)
    {
    ...
    public UnhollowedAssemblyContext? TryGetAssemblyByName(string name)
    {
