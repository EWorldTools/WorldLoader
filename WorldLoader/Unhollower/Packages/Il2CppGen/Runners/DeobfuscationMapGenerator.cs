...
{
    public static Il2CppGenGenerator AddDeobfuscationMapGenerator(this Il2CppGenGenerator gen)
    {
...
internal class DeobfuscationMapGeneratorRunner : IRunner
{
    ...
    private static (TypeRewriteContext?, int) FindBestMatchType(TypeRewriteContext obfType,
        UnhollowedAssemblyContext cleanAssembly, TypeRewriteContext? enclosingCleanType)
    {
