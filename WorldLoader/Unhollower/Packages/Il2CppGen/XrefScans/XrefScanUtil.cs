...
public static class XrefScanUtil
{
    ...
    public static unsafe bool CallMetadataInitForMethod(MethodBase method)
    {
        ...
        var nativeMethodInfoObject =
            Il2CppGenUtils.GetIl2CppMethodInfoPointerFieldForGeneratedMethod(method)?.GetValue(null);
    ...
    public delegate void InitMetadataForMethod(int metadataUsageToken);
}
