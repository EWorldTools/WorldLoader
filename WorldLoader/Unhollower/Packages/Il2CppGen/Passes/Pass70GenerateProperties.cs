...
internal static class Pass70GenerateProperties
{
    ...
    private static string UnmanglePropertyName(UnhollowedAssemblyContext assemblyContext, PropertyDefinition prop,
