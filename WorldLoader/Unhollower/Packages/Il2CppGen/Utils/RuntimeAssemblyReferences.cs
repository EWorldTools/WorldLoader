...
public class RuntimeAssemblyReferences
{
    ...
    internal RuntimeAssemblyReferences(ModuleDefinition module, RewriteGlobalContext globalContext)
    {
        Module = module;
    ...
    private void InitTypeRefs()
    {
        ...
        var assemblyRef = new AssemblyNameReference("Il2CppGen.Runtime", new Version(0, 0, 0, 0));
        Module.AssemblyReferences.Add(assemblyRef);

        Il2CppObjectBase =
            new TypeReference("Il2CppGen.Runtime.InteropTypes", "Il2CppObjectBase", Module, assemblyRef);

        Il2CppStringArray = new TypeReference("Il2CppGen.Runtime.InteropTypes.Arrays", "Il2CppStringArray", Module,
            assemblyRef);

        Il2CppArrayBase = new TypeReference("Il2CppGen.Runtime.InteropTypes.Arrays", "Il2CppArrayBase`1", Module,
            assemblyRef);
        Il2CppArrayBase.GenericParameters.Add(new GenericParameter("T", Il2CppArrayBase));

        Il2CppStructArray = new TypeReference("Il2CppGen.Runtime.InteropTypes.Arrays", "Il2CppStructArray`1",
            Module,
            assemblyRef);
        Il2CppStructArray.GenericParameters.Add(new GenericParameter("T", Il2CppStructArray));

        Il2CppReferenceArray = new TypeReference("Il2CppGen.Runtime.InteropTypes.Arrays", "Il2CppReferenceArray`1",
            Module, assemblyRef);
        Il2CppReferenceArray.GenericParameters.Add(new GenericParameter("T", Il2CppReferenceArray));

        Il2CppClassPointerStore = new TypeReference("Il2CppGen.Runtime", "Il2CppClassPointerStore`1",
            Module, assemblyRef);
        Il2CppClassPointerStore.GenericParameters.Add(new GenericParameter("T", Il2CppClassPointerStore));

        Il2Cpp = new TypeReference("Il2CppGen.Runtime", "IL2CPP", Module, assemblyRef);

        RuntimeReflectionHelper =
            new TypeReference("Il2CppGen.Runtime", "RuntimeReflectionHelper", Module, assemblyRef);

        DelegateSupport = new TypeReference("Il2CppGen.Runtime", "DelegateSupport", Module, assemblyRef);

        Il2CppException = new TypeReference("Il2CppGen.Runtime", "Il2CppException", Module, assemblyRef);

        allTypes["Il2CppGen.Runtime.InteropTypes.Il2CppObjectBase"] = Il2CppObjectBase;
        allTypes["Il2CppGen.Runtime.InteropTypes.Arrays.Il2CppStringArray"] = Il2CppStringArray;
        allTypes["Il2CppGen.Runtime.InteropTypes.Arrays.Il2CppReferenceArray<T>"] = Il2CppReferenceArray;
        allTypes["Il2CppGen.Runtime.InteropTypes.Arrays.Il2CppStructArray<T>"] = Il2CppStructArray;
        allTypes["Il2CppGen.Runtime.Il2CppException"] = Il2CppException;
        allTypes["Il2CppGen.Runtime.IL2CPP"] = Il2Cpp;
    }
    ...
    private void InitMethodRefs()
    {
        ...
        {
            var owner = ResolveType("Il2CppGen.Runtime.InteropTypes.Arrays.Il2CppReferenceArray<T>");
        ...
        {
            var mr = new MethodReference(".ctor", ResolveType("System.Void"),
                ResolveType("Il2CppGen.Runtime.InteropTypes.Arrays.Il2CppStringArray"));
            mr.HasThis = true;
        ...
        {
            var owner = ResolveType("Il2CppGen.Runtime.InteropTypes.Arrays.Il2CppStructArray<T>");
            var gp = owner.GenericParameters[0];
            var giOwner = new GenericInstanceType(owner);
            giOwner.GenericArguments.Add(param);
            var mr = new MethodReference(".ctor", ResolveType("System.Void"),
        ...
        IL2CPP_Il2CppObjectBaseToPtr = new Lazy<MethodReference>(() =>
        {
            var mr = new MethodReference("Il2CppObjectBaseToPtr", ResolveType("System.IntPtr"),
                ResolveType("Il2CppGen.Runtime.IL2CPP"));
            mr.HasThis = false;
            mr.Parameters.Add(new ParameterDefinition("", ParameterAttributes.None,
                ResolveType("Il2CppGen.Runtime.InteropTypes.Il2CppObjectBase")));
            return mr;
        });
        ...
        Il2CppException_RaiseExceptionIfNecessary = new Lazy<MethodReference>(() =>
        {
            var mr = new MethodReference("RaiseExceptionIfNecessary", ResolveType("System.Void"),
                ResolveType("Il2CppGen.Runtime.Il2CppException"));
            mr.HasThis = false;
            mr.Parameters.Add(new ParameterDefinition("", ParameterAttributes.None, ResolveType("System.IntPtr")));
            return mr;
        });
