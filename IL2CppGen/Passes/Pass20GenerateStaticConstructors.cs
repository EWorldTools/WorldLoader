...
internal static class Pass20GenerateStaticConstructors
{
    ...
    internal static void DoPass(RewriteGlobalContext context)
    {
        ...
        Logger.Instance.LogTrace($"Tokenless method count: {ourTokenlessMethods}");
    }

    private static void GenerateStaticProxy(UnhollowedAssemblyContext assemblyContext, TypeRewriteContext typeContext)
    {
