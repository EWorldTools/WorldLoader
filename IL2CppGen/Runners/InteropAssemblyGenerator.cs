...
{
    public static Il2CppInteropGenerator AddAssemblyGenerator(this Il2CppInteropGenerator gen)
    {
...
internal class InteropAssemblyGeneratorRunner : IRunner
{
    public void Run(GeneratorOptions options)
    {
        ...
        Logger.Instance.LogInformation($"{Pass18FinalizeMethodContexts.TotalPotentiallyDeadMethods} total potentially dead methods");
